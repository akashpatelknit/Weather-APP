...
const air_co=document.querySelector(".a span");
const air_no2=document.querySelector(".b span");
const air_o3=document.querySelector(".c span");
const air_so2=document.querySelector(".d span");
const air_us_epa_index=document.querySelector(".e span");
...
const fetchData = async (target) => {
  try {
    ...
    updateDom(temp_c, name, localtime, icon, text,humidity, wind_dir,
        wind_kph,
        wind_degree,co,no2,o3,so2,us_epa_index,moonrise,moonset,sunrise,sunset);
  } catch (error) {
...
function updateDom(temperate, city, time, emoji, text,humidity, wind_dir,
  ...
  air_co.innerText="CO = "+co;
  air_no2.innerText="NO2 = "+no2;
  air_o3.innerText="O3 = "+o3;
  air_so2.innerText="SO2 = "+so2;
  // air_us_epa_index.innerText="CO = "+us_epa_index;
